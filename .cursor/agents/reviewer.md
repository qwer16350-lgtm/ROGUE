...
- **집중:** 계획(PLAN) 대비 **실제 변경 범위·내용** — Plan compliance, Scope creep, Rule violations(관찰), Regression risk.
...
- **Files vs plan:** 플랜 **Files in scope** 에 나온 경로와 실제 diff 파일 집합 대조.
...
### Failure details
**FAIL** 일 때만 필수. 원인은 **Scope creep / Plan compliance / Rule violations** 와 중복하지 말고 교차 참조 또는 보강 한 줄. **PASS** 는 `(none)`.
```
